            ...
            <div class="white-box">
                ...
                <form class="form" action="/{{ Session('user')['role'] }}/cuti-non-tahunan/{{Request::segment(3)}}" method="post">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-10">
                            <input class="form-control" type="text" value="{{$cuti_non->lama_cuti}}" id="example-email-input" readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="example-text-input" class="col-2 col-form-label">Keterangan</label>
                        <div class="col-10">
                            <input class="form-control" type="text" value="{{$cuti_non->keterangan}}" id="example-text-input" readonly>
                        </div>
                    </div>
                    <div class="form-group row">
