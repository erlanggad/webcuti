                            ...
                            <tbody>
                                ...
                                @foreach ($data as $item)
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-capitalize">{{ $item['status'] }}
                                            @if ($item['status'] == 'disetujui')
                                                <br>({{ $item['verifikasi_oleh'] }})
                                            @endif
                                        </td>
                                        <td>
                                        ...
                                        <th>
                                            ...
                                            @if ($item['status'] == 'verifikasi')
                                                <form class="ml-auto mr-auto mt-3" method="POST"
                                                    action="/{{ Session('user')['role'] }}/manage-pengajuan-cuti/{{ $item['id_cuti_non'] }}">
                                                    {{ csrf_field() }}
                                                    {{ method_field('DELETE') }}
                                            ...
                                            @if ($item['status'] == 'disetujui')
                                                @if (in_array($role, ['karyawan']))
                                                    <a class="ml-auto mr-auto" target = "_blank"
                                                        href="/{{ Session('user')['role'] }}/print-tahunan/{{ $item['id_cuti_non'] }}">
