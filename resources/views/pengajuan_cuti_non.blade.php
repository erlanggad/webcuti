...
@endif
                                    ...
                                    @if ($item->status == 'disetujui')
                                    @if (in_array($role,['karyawan']))
                                    <a class="ml-auto mr-auto"  target = "_blank" href="/{{ Session('user')['role'] === "Karyawan" ? "karyawan" : Session('user')['role']  }}/print-non-tahunan/{{ $item->id_cuti_non}}">
...
<script>
    ...
    var url = "{{ Session('user')['role'] === 'karyawan' ? route('cuti_non.indexKaryawan') : (Session('user')['role'] === 'Manager' ? route('cuti_non.indexManager') : route('cuti_non.indexAdmin')) }}";
