...
class Manage_pengajuan_cuti extends Controller
{
    ...
    public function index_pengelola($request){
        ...
        $data['pengajuan_cuti'] = Pengajuan_cuti_non::join('karyawan','karyawan.id_karyawan','=','pengajuan_cuti.id_karyawan')->get();
    ...
    public function index_karyawan($request){
        ...
        $data['pengajuan_cuti'] = Pengajuan_cuti_non::join('karyawan','karyawan.id_karyawan','=','pengajuan_cuti.id_karyawan')
    ...
    {
        $data['pengajuan_cuti'] = Pengajuan_cuti_non::join('karyawan','karyawan.id_karyawan','=','pengajuan_cuti.id_karyawan')->where([
